...
struct LoginScreen_Previews: PreviewProvider {
    ...
    private class StubLoginScreenViewModel: LoginScreenLoader {
        ...
        var environmentViewModel: EnvironmentViewModel = EnvironmentViewModel(id: 1,
                                                       title: "Serbia",
                                                       image: "serbia_flag",
                                                                              env: Environment(host: APIConstants.serbiaHost, path: APIConstants.serbiaLangPath, clientSecret: serbiaClientSecret, cliendId: cliendIdSer, fileId: APIConstants.fileIdSerbia),
                                                        isSelected: false)

...
struct SetupDownloadAndUploadScreen_Previews: PreviewProvider {
        static var previews: some View {
            SetupDownloadAndUploadScreen(viewModel: SetupDownloadAndUploadScreenViewModel(items: SetupDownloadAndUploadMapper.getItems(),                              onCancelTapped: { _ in },                              onItemTapped: { _ in }))
    }
}
